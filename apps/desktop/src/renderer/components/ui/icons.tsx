...
export function IconCloseSidebar(props: IconProps) {
  ...
  return (
    <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...rest}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const EnterIcon = (props: LucideProps) => (
  <svg data-testid="geist-icon" height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const ClaudeCodeLogoIcon = (props: LucideProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 257" fill="currentColor" {...props}>
    <path
