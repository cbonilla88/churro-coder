...
>(({ className, children, ...props }, ref) => {
  ...
  const hasDescription = React.Children.toArray(children).some(
    (child) => React.isValidElement(child) && (child.props as Record<string, unknown>)?.['data-desc'] !== undefined
  );
  ...
  return (
    <SelectPrimitive.Item
      ...
      <SelectPrimitive.ItemText className="flex flex-col gap-0.5">{children}</SelectPrimitive.ItemText>
    </SelectPrimitive.Item>
  );
});
