  ...
  const setOfflineSimulationMutation = trpc.debug.setOfflineSimulation.useMutation({
    onSuccess: (data) => {
      ...
      toast.success(data.enabled ? 'Offline simulation enabled' : 'Offline simulation disabled', {
        description: data.enabled ? 'App will behave as if offline' : 'Network detection restored to normal'
      });
    },
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">System Info</h4>
      ...
      {/* DB Stats */}
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Database</h4>
        <div className="rounded-lg border bg-muted/30 divide-y">
      ...
      {isDev && (
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Developer Tools</h4>
          <div className="rounded-lg border bg-muted/30 divide-y">
            <div className="flex items-center justify-between p-3">
              <div className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Test offline mode without disconnecting</p>
                </div>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between p-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Display raw JSON below each message in chat</p>
                </div>
              </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button variant="outline" size="sm" onClick={handleCopyDebugInfo} disabled={isLoading}>
            {copiedInfo ? <Check className="h-4 w-4 mr-2 text-green-500" /> : <Copy className="h-4 w-4 mr-2" />}
            Copy Info
          </Button>
        </div>
      </div>
      ...
      {/* Toast Testing */}
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Toast Testing</h4>
        <div className="grid grid-cols-2 gap-2">
          <Button
            variant="outline"
            size="sm"
      ...
      {/* Data Management */}
      <div className="space-y-3">
        <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wide">Data Management</h4>
