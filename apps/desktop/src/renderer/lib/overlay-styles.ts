...
export const overlayItemFocus = 'focus:bg-accent dark:focus:bg-neutral-800 focus:text-accent-foreground';
...
export const overlaySubTriggerOpen = 'data-[state=open]:bg-accent dark:data-[state=open]:bg-neutral-800';
