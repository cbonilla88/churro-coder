...
export const VSCODE_TO_CSS_MAP: Record<string, string[]> = {
  ...
  '--primary': ['button.background', 'focusBorder', 'textLink.foreground', 'activityBarBadge.background'],
  ...
  '--popover': ['dropdown.background', 'menu.background', 'editorWidget.background', 'editor.background'],
  '--popover-foreground': ['dropdown.foreground', 'menu.foreground', 'editorWidget.foreground', 'foreground'],
  ...
  '--accent': ['list.hoverBackground', 'list.activeSelectionBackground', 'editor.selectionBackground'],
