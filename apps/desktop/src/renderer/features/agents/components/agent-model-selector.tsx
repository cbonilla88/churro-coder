...
import { formatClaudeThinkingLabel, formatCodexThinkingLabel } from '../lib/models';
    ...
    <div className="py-1">
      <div
        ...
        className={cn(
          ...
          showSub ? 'dark:bg-neutral-800 bg-accent text-foreground' : 'dark:hover:bg-neutral-800 hover:text-foreground'
        )}>
            ...
            {filteredModels.length > 0 ? (
              <CommandGroup>
                {filteredModels.map((item) => {
                  ...
                  const is1M = item.type === 'claude' && item.model.id.endsWith('[1m]');
                  return (
                    <CommandItem
                      key={getItemKey(item)}
