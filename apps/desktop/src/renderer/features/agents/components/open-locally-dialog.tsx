...
export function OpenLocallyDialog({
  ...
  const isAnyLoading =
    importMutation.isPending || locateMutation.isPending || pickDestMutation.isPending || cloneMutation.isPending;
                ...
                {mode === 'no-projects' ? (
                  ...
                  <>
                    <div className="p-6">
                      ...
                      <p className="text-sm text-muted-foreground mb-5">
                        ...
                        <code className="px-1.5 py-0.5 bg-muted rounded text-foreground text-xs">{repository}</code>,
                        ...
                        <button
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-muted-foreground">Point us to your local copy</div>
                            </div>
                          </div>
                        </button>
                  ...
                  <>
                    <div className="p-6">
                      ...
                      <p className="text-sm text-muted-foreground mb-5">
                        You have{' '}
                        <code className="px-1.5 py-0.5 bg-muted rounded text-foreground text-xs">{repository}</code> in
                        multiple locations. Which one should we use?
                      </p>
