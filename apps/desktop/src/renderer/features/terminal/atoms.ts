...
export const terminalSidebarWidthAtom = atomWithStorage<number>('terminal-sidebar-width', 500, undefined, {
  getOnInit: true
});

// Terminal cwd tracking - window-scoped, maps paneId to current working directory
export const terminalCwdAtom = atomWithWindowStorage<Record<string, string>>('terminal-cwds', {}, { getOnInit: true });
...
export const terminalBottomHeightAtom = atomWithStorage<number>('terminal-bottom-height', 300, undefined, {
  getOnInit: true
});
