 ...
 */
export function showLinkPopup(event: MouseEvent, text: string, onOpen?: (url: string) => void): void {
 ...
 */
function createAndShowPopup(clientX: number, clientY: number, text: string, onOpen?: (url: string) => void): void {
