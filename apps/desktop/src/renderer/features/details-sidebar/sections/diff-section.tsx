          ...
          <div className="flex items-center gap-2 text-xs font-mono">
            ...
            <span className="tabular-nums whitespace-nowrap">
              {diffStats.additions > 0 && (
                <span className="mr-1.5 text-emerald-600 dark:text-emerald-400">+{diffStats.additions}</span>
              )}
                ...
                return (
                  <div
                    ...
                    <div className="flex items-center gap-2 min-w-0 flex-1">
                      ...
                      {isNewFile && (
                        <span className="shrink-0 text-[11px] text-emerald-600 dark:text-emerald-400">(new)</span>
                      )}
                      {isDeletedFile && (
          ...
          <div className="flex gap-2 pt-1">
            ...
            {onCommit && (
              <Button
                ...
                {isCommitting ? <IconSpinner className="h-3 w-3 mr-1.5" /> : <GitCommit className="h-3 w-3 mr-1.5" />}
                Commit
              </Button>
            )}
