      ...
      <div className="relative flex items-center justify-between h-10 px-2 border-b border-border/50 bg-background flex-shrink-0">
        ...
        <div
          ...
          <div className="h-6 px-2 gap-1 text-xs font-medium min-w-0 flex items-center">
            ...
            <span className="truncate max-w-[120px] text-foreground">{currentBranch || 'No branch'}</span>
          </div>
        ...
        <div
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  {isReviewing ? <IconSpinner className="size-3.5" /> : <IconReview className="size-3.5" />}
                  <span>Review</span>
                </Button>
              </TooltipTrigger>
            ...
            <div className="inline-flex -space-x-px rounded-md">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  ...
                  <DropdownMenuItem onClick={handleFetch} disabled={isFetchPending} className="text-xs">
                  ...
                  {hasUpstream && pullCount > 0 && (
                    <DropdownMenuItem
                      ...
                      <div className="flex-1">
                        <div>Force push</div>
                        <div className="text-[10px] text-muted-foreground/70">Overwrite remote (dangerous)</div>
                      </div>
                    </DropdownMenuItem>
                  )}
                  ...
                  {((hasUpstream && !pr && onCreatePr && !isDefaultBranch && primaryAction.label !== 'Create PR') ||
                    (hasUpstream &&
                      ...
                      onCreatePrWithAI &&
                      !isDefaultBranch &&
                      primaryAction.label !== 'Create PR with AI') ||
                    pr ||
                  ...
                  {hasUpstream &&
                    ...
                    !isDefaultBranch &&
                    primaryAction.label !== 'Create PR with AI' && (
                      <DropdownMenuItem onClick={onCreatePrWithAI} disabled={isCreatingPrWithAI} className="text-xs">
                        <GitPullRequest className="mr-2 size-3.5" />
                        <div className="flex-1">
                          <div>{isCreatingPrWithAI ? 'Creating...' : 'Create PR with AI'}</div>
                          <div className="text-[10px] text-muted-foreground">Let AI create and push PR</div>
                        </div>
                      </DropdownMenuItem>
                    )}
          ...
          {showViewModeToggle && onViewModeChange && (
            <div className="inline-flex rounded-md border border-input">
              <Button
                ...
                className={cn('h-6 w-6 p-0 rounded-r-none border-0', viewMode !== 'split' && 'hover:bg-foreground/10')}
                title="Split view">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="h-6 w-6 p-0 flex-shrink-0 hover:bg-foreground/10">
            ...
            <DropdownMenuContent align="end" className="w-48">
              ...
              {!showReviewButton && onReview && <DropdownMenuSeparator />}
