...
describe('useGroupedAgentChats', () => {
  const chats = [
    { id: 'c1', name: 'Alpha one', updatedAt: new Date('2026-05-07T10:00:00Z'), projectId: 'p1', isRemote: false },
    { id: 'c2', name: 'Beta two', updatedAt: new Date('2026-05-07T11:00:00Z'), projectId: 'p2', isRemote: false }
  ];
