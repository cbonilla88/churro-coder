 ...
 */
export async function withGitLock<T>(worktreePath: string, operation: () => Promise<T>): Promise<T> {
 ...
 */
export async function cleanStaleLockFiles(worktreePath: string, maxAgeMs: number = 5 * 60 * 1000): Promise<string[]> {
