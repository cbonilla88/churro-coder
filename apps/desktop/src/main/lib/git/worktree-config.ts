 ...
 */
export async function detectWorktreeConfig(projectPath: string, customPath?: string): Promise<DetectedWorktreeConfig> {
 ...
 */
export async function executeWorktreeSetup(worktreePath: string, mainRepoPath: string): Promise<WorktreeSetupResult> {
